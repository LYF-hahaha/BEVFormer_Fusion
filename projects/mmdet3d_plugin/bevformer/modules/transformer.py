...
class PerceptionTransformer(BaseModule):
    ...
    def forward(self,
        ...
        fusion_bev_feature = self.get_bev_features(  # 这里是 encoder & decoder 一起
        ...
        fusion_bev_feat_orig = fusion_bev_feature.clone().detach()
        ...
        fusion_bev_feature = fusion_bev_feature.permute(1,0,2)
        inter_states, inter_references = self.decoder(
            query=query,
            key=None,
            value=fusion_bev_feature,
            query_pos=query_pos,
        ...
        return fusion_bev_feat_orig, inter_states, init_reference_out, inter_references_out
        # img_bev_feat_orig, bev_embed,